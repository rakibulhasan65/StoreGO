...
<body class="<?php echo e($color); ?>">
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center mobile-screen">
                <div class="col-auto">
                    <div class="wow animate__fadeInRight mobile-widget" data-wow-delay="0.2s">
                        ...
                        <img src="<?php echo e(!empty($company_logo) ? $logo . $company_logo : $logo . 'logo-light.png'); ?>"
                            alt="">
            ...
            <img style="border-radius: 15px;" src="<?php echo e(asset('landing/images/storego-saas-pic-1.png')); ?>"
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="<?php echo e(asset('landing/images/storego-saas-pic-2.png')); ?>" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
                ...
                <div class="col-xl-9 col-lg-6 col-md-12 col-sm-12">
                    <div class="row feature-img-row m-auto">
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('landing/images/storego-saas-pic-3.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('landing/images/storego-saas-pic-4.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.4s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('landing/images/storego-saas-pic-5.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.6s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('landing/images/storego-saas-pic-7.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.8s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('landing/images/storego-saas-pic-9.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.3s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('landing/images/storego-saas-pic-8.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.5s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('landing/images/storego-saas-pic-6.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.7s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('landing/images/storego-saas-pic-10.png')); ?>"
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    <p class="text-body"><?php echo e(__('Copyright')); ?>
                        ...
                        <?php echo e(Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'StoreGo')); ?>
...
<?php /**PATH C:\xampp\htdocs\Diligent Soft IT\StoreGo\resources\views/layouts/landing.blade.php ENDPATH**/ ?>